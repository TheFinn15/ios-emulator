...
export function PhoneContainer() {
  ...
  const wallpaper = 'https://9to5mac.com/wp-content/uploads/sites/6/2021/09/1952.Light_Beams_Silver_Dark-428w-926h@3xiphone.jpeg?strip=info&w=1542';
  ...
  return (
      <div className={'phone-container'} style={styles}>
        ...
        <div className={'phone-container__controls-power-off'} onClick={() => onPowerOff()} />
        ...
        */}
        <div ref={mainScreenRef} className={'phone-container__screen'} style={{backgroundImage: `url(${defaultWallpaper})`}}>
