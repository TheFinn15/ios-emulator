...
export const LockScreen = ({ onSwipe }: LockScreenParams) =>
  // ref: React.Ref<HTMLDivElement>
  {
    ...
    return (
      <div className={"lock-screen"}>
        ...
        <div className="lock-screen__time">{currentTime}</div>
        <div className="lock-screen__date">{currentDate}</div>
        ...
        <SwipeContainer
          toBlur={false}
          swipeTo="top"
          handler={{ onSwipe: (direction, pos) => onSwipe(direction, pos) }}
        >
